...
const ABILITY_CLASS_MAP: Record<string,string> = {
  ...
  // Medic
  'bacta burst':'Medic','bacta spray mark 6':'Medic','bacta ampule mark 6':'Medic','vital strike':'Medic','nerve gas':'Medic','serotonin purge':'Medic', 'rheumatic calamity':'Medic',
};
